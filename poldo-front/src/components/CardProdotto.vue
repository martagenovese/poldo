      ...
      <div class="card-side card-front">
        <div class="card-prodotto">
          ...
          <div class="quantity-controls">
            <button v-if="inCartView" 
              class="quantity-btn delete"
...
.card-back {
  transform: rotateY(180deg);
  pointer-events: none; /* Disable pointer events on the back card container */
}

/* This is important - enable pointer events when flipped */
.card-wrapper.is-flipped .card-back {
  pointer-events: auto; /* Re-enable pointer events when card is flipped */
}

.card-back .card-prodotto,
.card-back .details,
.card-back .quantity-controls {
  pointer-events: auto; /* Enable pointer events for all content on back */
}
...
.details {
  ...
  z-index: 100; /* Higher than other elements to ensure it receives events */
...
.quantity-btn.plus:hover {
  background-color: var(--green); /* Slightly darker green on hover */
}
...
.quantity-btn.minus:hover {
  background-color: var(--red); /* Slightly darker red on hover */
}
